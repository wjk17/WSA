...
namespace Esa.UI
{
    ...
    public static class GLUI
    {
        ...
        {
            UI.AddCommand(Cmd(-1, GLUICmdType.LoadOrtho));
        }
        /// <summary>
        /// 左上角坐标
        /// </summary>
        ...
        {
            UI.AddCommand(Cmd(commandOrder, GLUICmdType.DrawLineOrtho, p1, p2));
        }
        public static void DrawLine(Vector2 p1, Vector2 p2, Color color)
        {
            UI.AddCommand(Cmd(commandOrder, GLUICmdType.DrawLineOrtho, p1, p2, color));
        }
        public static void DrawLine(Vector2 p1, Vector2 p2, Color color, bool clip)
        {
            UI.AddCommand(Cmd(commandOrder, GLUICmdType.DrawLineOrtho, p1, p2, color, clip));
        }
        public static void DrawLine(Vector2 p1, Vector2 p2, float width)
        {
            UI.AddCommand(Cmd(commandOrder, GLUICmdType.DrawLineOrtho, p1, p2, width));
        }
        public static void DrawLine(Vector2 p1, Vector2 p2, float width, Color color)
        {
            UI.AddCommand(Cmd(commandOrder, GLUICmdType.DrawLineOrtho, p1, p2, width, color));
        }
        ...
        {
            p1.y = UI.scaler.referenceResolution.y - p1.y;
            p2.y = UI.scaler.referenceResolution.y - p2.y;
            SetLineMaterial();
            GL.LoadOrtho();
        ...
        public static void DrawLineOrtho(Vector2 p1, Vector2 p2, Color color, bool clip = true)
        {
            ...
            //normalize & flip y
            p1.x /= UI.scaler.referenceResolution.x;
            p1.y = UI.scaler.referenceResolution.y - p1.y;
            p1.y /= UI.scaler.referenceResolution.y;
            p2.x /= UI.scaler.referenceResolution.x;
            p2.y = UI.scaler.referenceResolution.y - p2.y;
            p2.y /= UI.scaler.referenceResolution.y;
